...
from textual.containers import Container, VerticalScroll, HorizontalScroll, Horizontal
...
PRIORITIES = {
    ...
    '6-waiting': {'prev': '5-someday', 'next': 'None'},
}
...
class Card(Static, can_focus=True):
    ...
    def action_move_left(self) -> None:
        self.post_message(self.MoveLeft(filename=self.name))

    def action_move_right(self) -> None:
        self.post_message(self.MoveRight(filename=self.name))
